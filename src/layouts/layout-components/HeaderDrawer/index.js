  ...
  return (
    <Fragment>
      <Hidden smDown>
        ...
        <Drawer anchor="right" open={open} variant="temporary" elevation={4} onClose={handleDrawerOpen}>
          <Box className="app-header-drawer">
            <PerfectScrollbar>
              <div className="p-4">
                <div className="text-center">
                  <div className="font-weight-bold font-size-lg mb-0 text-black">Today's sales target</div>
                  <p className="text-black-50">Daily statistics regarding your sales targets</p>
                </div>
              ...
              <div className="p-4 text-center">
                <h3 className="mb-0 display-3 mt-1 font-weight-bold">
                  $<span className="pr-1">{/* <CountUp start={0} end={458.695} duration={4} separator="" delay={3} decimals={3} decimal="," prefix="" suffix="" /> */}</span>
                </h3>
              ...
              <div className="p-4">
                <div className="text-center">
                  <div className="font-weight-bold font-size-lg mb-0 text-black">Tasks</div>
                    ...
                    <div className="task-item">
                      <div className="align-box-row">
                        ...
                        <div>
                          ...
                          <p className="text-black-50 mt-1 mb-0">But I must explain to you how all this mistaken idea.</p>
                        </div>
                      </div>
                    </div>
                    <div className="task-item">
                      <div className="align-box-row">
                        ...
                        <div>
                          ...
                          <p className="text-black-50 mt-1 mb-0">A wonderful serenity has taken possession.</p>
                    ...
                    <div className="task-item">
                      <div className="align-box-row">
                        ...
                        <div className="w-100">
                          ...
                          <p className="text-black-50 mt-1">Who formed us in his own image, and the breath.</p>
                          <List>
              ...
              <div className="p-4">
                <div className="text-center">
                  <div className="font-weight-bold font-size-lg mb-0 text-black">Latest sales</div>
