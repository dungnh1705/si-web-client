...
function PageTitle(props) {
  ...
  return (
    <Fragment>
      <Paper square elevation={pageTitleShadow ? 6 : 2} className={clsx('app-page-title', pageTitleStyle, pageTitleBackground)}>
        <div>
          {pageTitleBreadcrumb && (
            <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} className="mb-4" maxItems={2} aria-label="breadcrumb">
              <Link
                color="inherit"
                to="#"
                onClick={e => {
          ...
          <Box className="app-page-title--first">
            {pageTitleIconBox && (
              <Paper elevation={2} className="app-page-title--iconbox d-70 d-flex align-items-center bg-secondary justify-content-center">
                <DashboardTwoToneIcon />
              </Paper>
            )}
            <div className="app-page-title--heading">
              <h1>{props.titleHeading}</h1>
              {pageTitleDescription && <div className="app-page-title--description">{props.titleDescription}</div>}
            </div>
          </Box>
        </div>
        ...
        {/* {!open && (
          <div className="d-flex align-items-center">
            <Button onClick={toggle1} variant="contained" color="secondary">
              ...
              <span className="btn-wrapper--icon d-block d-xl-none"></span>
            </Button>
                ...
                <Grid item xs={12} lg={5}>
                  <div className="hero-wrapper bg-composed-wrapper bg-plum-plate h-100">
                    <div className="flex-grow-1 w-100 d-flex align-items-center">
                      <div className="bg-composed-wrapper--image " style={{ backgroundImage: 'url(' + hero1 + ')' }} />
                      ...
                      <div className="bg-composed-wrapper--content p-5">
                        ...
                        <div className="text-white mt-3">
                          <h1 className="display-4 my-3 font-weight-bold">Wonderful serenity has possession</h1>
                          <p className="font-size-md mb-0 text-white-50">A free hour, when our power of choice is untrammelled and when nothing prevents.</p>
                    ...
                    <div className="hero-footer pb-4">
                      <div className="d-flex justify-content-center">
                        <Tooltip arrow title="Facebook">
                          <IconButton color="primary" size="medium" variant="outlined" className="text-white"></IconButton>
                        </Tooltip>
                      ...
                      <Grid container spacing={4}>
                        <Grid item md={6} lg={4}>
                          <Card className="card-box text-black-50 bg-secondary mb-5 p-3">
                            <div className="display-3 text-black font-weight-bold">31</div>
                        ...
                        <Grid item md={6} lg={4}>
                          <Card className="card-box text-black-50 bg-secondary mb-5 p-3">
                            <div className="display-3 text-black font-weight-bold">68</div>
                        ...
                        <Grid item md={6} lg={4}>
                          <Card className="card-box text-black-50 bg-secondary mb-5 p-3">
                            <div className="display-3 text-black font-weight-bold">57</div>
                      ...
                      <Card className="m-0 bg-secondary border-0">
                        ...
                        <CardContent className="p-3">
                          ...
                          <form className="px-5">
                            ...
                            <div className="w-100">
                              <FormControlLabel control={<Checkbox checked={checked1} onChange={handleChange1} value="checked1" color="primary" />} label="Remember me" />
                            </div>
                            <div className="text-center">
                          ...
                          <Card className="card-box bg-secondary mb-5">
                            ...
                            <CardContent className="px-4 py-3">
                              ...
                              <div className="d-flex align-items-center justify-content-start">
                                ...
                                <div className="font-size-sm text-danger px-2">14:22</div>
                              </div>
                            </CardContent>
                          </Card>
                        </Grid>
                          ...
                          <Card className="card-box bg-secondary mb-5">
                            ...
                            <CardContent className="px-4 py-3">
                              ...
                              <div className="d-flex align-items-center justify-content-start">
                                ...
                                <div className="font-size-sm text-dark px-2">09:41</div>
                              </div>
                            </CardContent>
                          </Card>
                        </Grid>
                      ...
                      <div className="timeline-list">
                        <div className="timeline-item timeline-item-icon">
                          <div className="timeline-item--content">
                            <div className="timeline-item--icon-wrapper bg-danger text-white"></div>
                            <h4 className="timeline-item--label mb-2 font-weight-bold">1998</h4>
                        ...
                        <div className="timeline-item">
                          <div className="timeline-item--content">
                            ...
                            <h4 className="timeline-item--label mb-2 font-weight-bold">Java exam day</h4>
                            <p>Bill Clinton's presidential scandal makes it online.</p>
                        ...
                        <div className="timeline-item">
                          <div className="timeline-item--content">
                            ...
                            <h4 className="timeline-item--label mb-2 font-weight-bold">
                              ...
                              <span className="text-info ml-2 badge badge-neutral-info">New</span>
                            </h4>
        ...
        <Hidden smDown>
          <div className="speedial-wrapper">
            <SpeedDial ariaLabel="SpeedDial menu" icon={<SpeedDialIcon openIcon={<EditIcon />} />} onClose={handleClose} onOpen={handleOpen} direction="left" open={open}>
              {actions.map(action => (
